...
async function main() {
    const db = new Database("mongodb+srv://Pom:hello@cluster0.p2myy.mongodb.net/todolist?retryWrites=true&w=majority");
    await db.connect();
    server.listen(config.PORT, () => {
        console.log(`Server is running bruhh bruhh ${config.HOST}:${config.PORT}`);
    });
}
